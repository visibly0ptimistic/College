...
public class Chapter7Learning {
  public static void main(String[] args) throws IOException {
	...
	*/
	...
	System.out.println();
   /* This is very common - to have the first element in a file specify how many elements are in that file.
      It keeps the program adjustable to any file it needs to process.
      For example, a payroll program.  You can run payroll on Lumberjack company that has 1,500 employees
      and then run it on PurpleCo that has 2,100 employess without having to change the program.
      In practice, the program would read in the file name instead of hard coding the file name in
      as done so here in our learning examples.
   */
