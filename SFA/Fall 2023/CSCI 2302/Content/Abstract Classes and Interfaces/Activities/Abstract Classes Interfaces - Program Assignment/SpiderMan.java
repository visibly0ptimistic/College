...
public class SpiderMan extends Being implements Movement{
    private int agilityLevel;
    private String webType;
    private WebShooter tool;

    public SpiderMan(String name, int age, int agilityLevel, String webType, Planet homePlanet, WebShooter tool) {
    ...
    public String toString() {
        return "SpiderMan [name=" + this.name + ", agilityLevel=" + this.agilityLevel + ", webType=" + this.webType + ", tool=" + this.tool.toString() + ", homePlanet=" + this.homePlanet.toString() + "]";
    }

    @Override
    public void makeSound() {
        System.out.println("Thwip, thwip!");
    }

    @Override
    public void modeOfMovement() {
        System.out.println("Swinging between buildings.");
    }
}