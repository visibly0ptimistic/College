...
public class GreenGoblin extends Being {
    private String gadgets;
    private String motive;
    private String hideout;

    public GreenGoblin(String name, int age, String gadgets, String motive, String hideout) {
        super(name, age);
    ...
    public String toString() {
        return "GreenGoblin [name=" + this.name + ", age=" + this.age + ", gadgets=" + this.gadgets + ", motive=" + this.motive + ", hideout=" + this.hideout + "]";
    }
}